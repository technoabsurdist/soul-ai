...
export default function Home({ userPermission }) {
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          <a>Dreams</a>
          <a className={styles.emojiTitle}>💭️</a>
        ...
        <MenuOptions />
        {/* <a 
          href="https://github.com/technoabsurdist/prompt-image-editing" 
          target="_blank" 
